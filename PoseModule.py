...
class poseDetector():
    ...
    def findAngle(self,img,p1,p2,p3,draw=True):
        ...
        #Angle Calculation
        angle=math.degrees(math.atan2(y1-y2,x2-x1)-math.atan2(y3-y2,x3-x2))
        if angle<0:
            angle+=360

        #Drawing the movement points
        if draw:
            ...
            cv2.putText(img,str(int(angle)),(x2-50,y2+50),cv2.FONT_HERSHEY_PLAIN,2,(0,0,255),3)
